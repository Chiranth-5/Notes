...
// Node* AVL::inOrderSuc(struct Node * p)
// {   
//     if( p == nullptr)
//     {
//         return nullptr;
...
// Node* AVL::inOrderPre(struct Node * p)
// {   
//     if( p == nullptr)
//     {
//         return nullptr;
...
// Node* AVL::deleteR(struct Node * p , int key)
// {
//     Node *q= nullptr;
...
//     tll.root = tll.rInsert(tll.root, 15);
//     tll.root = tll.rInsert(tll.root, 5);
...
//     tll.deleteR(tll.root , 15);
//     tll.Inorder();
//     cout << endl;

//     tll.deleteR(tll.root , 30);
//     tll.Inorder();
